...
old_posteriors = lapply(cogs, posterior_gen, grid = p_grid, prior = app_prior, data = y2_data,
       give_sample = F)
...
tidy_posterior_plot(9, 10, 3, 6) +
  labs(title = "Riccardo", y = "density")

tidy_posterior_plot(34, 65, 66, 132) +
  labs(title = "Mikkel", y = "density")

tidy_posterior_plot(148, 172, 160, 198) +
  labs(title = "Josh", y = "density")

tidy_posterior_plot(8, 12, 2, 4) +
  labs(title = "Kristian", y = "density")
